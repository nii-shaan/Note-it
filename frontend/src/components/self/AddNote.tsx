					...
					<form onSubmit={handleSubmit(onSubmit)}>
						...
						<div className="my-4 flex justify-center gap-x-3 pc:gap-x-6">
							...
							<div className="flex flex-col">
								...
								<input id="title" {...register("title", { required: "Title is required !" })} className="bg-transparent border-2 text-center outline-none rounded-lg py-1 focus:border-green-300" />
