...
function Home() {
  ...
  return (
    <div className="min-h-[500px] tablet:min-h-[800px] bg-main pc:mt-32">
      <div id="head" className="red-100 text-xl mt-16">
        ...
        <div id="button" className="w-full flex justify-center mt-16">
      ...
      <div className="flex justify-center my-16">
        <div className="bg-second w-[300px] p-5 rounded-lg tablet:w-[500px] pc:w-[950px]">
          <div className=" mb-4">
            -Keep all your thoughts and important information in one place.
            Easily manage your notes with an intuitive interface.
          </div>
          <div className="mb-4">
            -Never miss a task! Set and manage your daily to-do list with our simple reminder feature.
          </div>
          <div className="">
            -Enjoy a clean, distraction-free layout to focus on what matters most.
          </div>
        </div>
      </div>
